...
import { addCharity } from "../../reducers/CharitySlice.ts";
import {
                    ...
                    <div className="flex-1 p-12">
                        ...
                        <div className="py-4 px-[10px]">
                            ...
                            <form className="flex flex-col">
                                ...
                                <button
                                    type="button"
                                    className="mt-[40px] px-4 bg-[#17502E] text-white rounded-[10px] hover:bg-[#1A6D3B] w-full h-[40px] flex items-center justify-center text-[15px] float-right"
